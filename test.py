...
#cpo(env_fn = lambda : env,FileName="CPO_Seed4_new", seed = 0 ,alpha = 0,epochs=150,cost_lim=25,ac_kwargs=dict(hidden_sizes=(64, 32)))
trpo_lagrangian(env_fn = lambda : env,FileName="TRPO_Seed1_new_one_signal_alpha_0_25",alpha =0.25 ,epochs=150,cost_lim=10,seed =1,ac_kwargs=dict(hidden_sizes=(64, 32)))
